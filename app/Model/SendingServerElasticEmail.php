...
use function Acelle\Helpers\file_get_contents_ssl_safe;
...
class SendingServerElasticEmail extends SendingServer
{
    ...
    public function enableCustomHeaders()
    {
        ...
        $response = file_get_contents_ssl_safe($uri);
    ...
    public function setupWebhooks()
    {
        ...
        $response = json_decode(file_get_contents_ssl_safe($endpoint), true);
    ...
    public function deleteWebHook()
    {
        ...
        $webhooks = json_decode(file_get_contents_ssl_safe($loadUri), true)['data'];
        ...
        foreach ($webhooks as $webhook) {
            ...
            if ($this->isSubscribeUrl($webhook['url']) || $webhook['name'] == self::WEBHOOK_NAME) {
                ...
                $result = json_decode(file_get_contents_ssl_safe($deleteUri), true);
    ...
    public function syncIdentities()
    {
        ...
        $response = file_get_contents_ssl_safe(self::API_ENDPOINT.'/domain/list?apikey='.$this->api_key);
