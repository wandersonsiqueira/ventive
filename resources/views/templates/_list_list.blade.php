            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="text-muted">
                        {!! $template->admin ? '<i class="icon-user-tie" data="admin"></i>' . $template->admin->user->displayName() : '' !!}
                        {!! $template->customer ? '<i class="icon-user" data="customer"></i>' . $template->customer->user->displayName() : '' !!}
                    </div>
